(_=>{
    ...
    class GameDisplay {
        constructor() {
            ...
            this.canvas.canvas.addEventListener("mousedown", (e) => this.onMouseDown(e.clientX, e.clientY, e.button, e.ctrlKey));
            this.canvas.canvas.addEventListener("mouseup", (e) => this.onMouseUp(e.clientX, e.clientY));
            this.canvas.canvas.addEventListener("mousemove", (e) => this.onMouseMove(e.clientX, e.clientY, e.ctrlKey));
            this.canvas.canvas.addEventListener("wheel", (e) => this.onMouseWheel(e.deltaY));

            this.canvas.canvas.oncontextmenu = e=>e.preventDefault();
        ...
        fillTriAt(x1, x2, x3, x4, x5, y1, y2, j) {
            switch (j & 3) {
                case 0:
                    this.canvas.fillPolygon([0, 0], [[y1, x1], [y2, x2], [y1, x3]]);
                    break;
                case 1:
                    this.canvas.fillPolygon([0, 0], [[y2, x2], [y1, x3], [y2, x4]]);
                    break;
                case 2:
                    this.canvas.fillPolygon([0, 0], [[y1, x2], [y2, x3], [y1, x4]]);
                    break;
                case 3:
                    this.canvas.fillPolygon([0, 0], [[y2, x3], [y1, x4], [y2, x5]]);
                    break;
            }
        }
